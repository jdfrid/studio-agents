export const en = {
  ...
  advanced: {
    ...
    optionValues: {
      ...
      airport_pa: "Airport PA announcer",
      hotel_pa: "Hotel PA announcer",
      beach_lifeguard: "Beach lifeguard",
      retro_radio: "Retro radio voice",
      on: "On",
      off: "Off",
      auto: "Automatic",
      manual: "Manual",
...
export const he = {
  ...
  advanced: {
    ...
    optionValues: {
      ...
      airport_pa: "כרוז בשדה התעופה", hotel_pa: "כרוז בבית מלון", beach_lifeguard: "מציל בחוף הים", retro_radio: "קול רדיו רטרו",
